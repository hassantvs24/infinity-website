                                        ...
                                        <Card.Body>
                                            ...
                                            <Card.Text>
                                                ...
                                                <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullet" icon={faCheckCircle} /> Implementation</p>
                                                 <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullet" icon={faCheckCircle} /> Complete project with client reqirment</p>
                                                 <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullet" icon={faCheckCircle} /> handle to project on time</p>

                                                <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullet" icon={faCheckCircle} />Try to student maximum level best care</p>
                                                <p className="cardSubTitle text-justify"><FontAwesomeIcon className="iconBullet" icon={faCheckCircle} />Life Time membership for students</p>
                                            </Card.Text>
                                        </Card.Body>
                                     </Card>
                                </Col>
